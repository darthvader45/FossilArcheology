...
//        LanguageRegistry.instance().addStringLocalization(((BlockPalaeSlab)palaeSingleSlab).getFullSlabName(0)+".name", "Palae SingleSlab");
        ...
        EntityRegistry.registerModEntity(EntityStoneboard.class,        "StoneBoard",           1, this, 250, 2147483647, false);
        ...
        EntityRegistry.registerModEntity(EntityPregnantSheep.class,     "PregnantSheep",        19, this, 250, 3, true);
        EntityRegistry.registerModEntity(EntityPregnantCow.class,       "PregnantCow",          20, this, 250, 3, true);
        EntityRegistry.registerModEntity(EntityPregnantPig.class,       "PregnantPig",          21, this, 250, 3, true);
        ...
        //EntityRegistry.registerModEntity(EntitySpinosaurus.class,         "Spinosaurus",          25, this, 250, 5, true);
          EntityRegistry.registerModEntity(EntityDodo.class,           "Dodo",              25, this, 250, 3, true);
           EntityRegistry.registerModEntity(EntityDodoEgg.class,           "DodoEgg",              26, this, 250, 10, true);
           EntityRegistry.registerModEntity(EntityCultivatedDodoEgg.class,           "CultivatedDodoEgg",              27, this, 250, 10, true);
