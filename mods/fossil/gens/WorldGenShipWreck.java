...
import mods.fossil.RelicHoleList;
import mods.fossil.entity.mob.EntityBones;
import mods.fossil.fossilEnums.EnumShipTypes;
import mods.fossil.tags.ByteArrayTag;
import mods.fossil.tags.CompoundTag;
import mods.fossil.tags.NBTInputStream;
                            ...
                            for (int var12 = 0; var12 < this.WidthZ; ++var12)
                            {
                                for (int var10 = 0; var10 < this.WidthX; ++var10)
                                {
                                    ...
                                    else if (random.nextInt(10000) < 5)
                                    {
                                        ...
                                        if (world.checkNoEntityCollision(var17.boundingBox) && world.getCollidingBoundingBoxes(var17, var17.boundingBox).size() == 0)
                                        {
    ...
    private short SwapCargoBlock(Random var1)
    {
        ...
        switch (this.SelfType.ordinal())
        {
            ...
            case 2:
                if (var2 < 500)
                {
                    return (short)Block.blockIron.blockID;
                }
    ...
    public ItemStack GetRandomContent(Random var1)
    {
        ...
        switch (this.SelfType.ordinal())
        {
            ...
            case 2:
                ...
                if (var2 < 250)
                {
                    return new ItemStack(Block.blockIron, var1.nextInt(14) + 1);
                }
