...
public class ModelAnkylosaurus extends ModelBase
{
  ...
  public ModelAnkylosaurus()
  {
    ...
    textureHeight = 64;
      ...
      HeadHorn1.addBox(0F, 0F, 0F, 3, 3, 3);
      ...
      HeadHorn2.addBox(0F, 0F, 0F, 3, 3, 3);
      ...
      HeadHorn3.addBox(0F, 0F, 0F, 3, 3, 3);
      ...
      HeadHorn4.addBox(0F, 0F, 0F, 3, 3, 3);
      ...
      Front_ThighLeft.addBox(0F, 0F, 0F, 4, 4, 4);
      ...
      Back_ThighRight.addBox(0F, 0F, 0F, 4, 5, 5);
      ...
      Back_ThighLeft.addBox(0F, 0F, 0F, 4, 5, 5);
  ...
  protected void setRotationAngles(float var1, float var2, float var3, float var4, float var5, float var6, boolean var7)
  {
      ...
      //if (var7==false)
          ...
          Tail.rotateAngleY = ((float) Math.pow(0.25F, 1)) * (MathHelper.cos(-0.2F * var1 + initialOffset));
        ...
        TailClub.rotateAngleY = ((float) Math.pow(0.25F, 3)) * (MathHelper.cos(-0.2F * var1 + 1.1F * 2 * offset + PI / 9 + initialOffset)) - currentAngle;
