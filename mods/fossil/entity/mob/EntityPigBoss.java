 ...
 //       this.health = 100;
    ...
    */
	...
	public boolean getCanSpawnHere()
    {
        ...
        {
            boolean var1 = this.worldObj.difficultySetting > 0 && this.worldObj.checkNoEntityCollision(this.boundingBox) && this.worldObj.getCollidingBoundingBoxes(this, this.boundingBox).size() == 0 && !this.worldObj.isAnyLiquid(this.boundingBox);
 ...
 //           if (this.texture != "/mods/fossil/textures/PigBoss.png")
  ...
  //              this.texture = "/mods/fossil/textures/PigBoss.png";
   ...
   //             this.texture = "/mods/fossil/textures/PigBoss_Charging.png";
    ...
    {
        return this.getAttackMode() == 0 ? new ItemStack(Item.swordIron) : this.defaultHeldItem;
    }
