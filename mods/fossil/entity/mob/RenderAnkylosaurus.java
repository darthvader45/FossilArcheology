...
public class RenderAnkylosaurus extends RenderLiving
{
    ...
    public RenderAnkylosaurus(float var1)
    {
        super(new ModelAnkylosaurus(), var1);
    }
    ...
    public void renderNew(EntityAnkylosaurus var1, double var2, double var4, double var6, float var8, float var9)
    {
        GL11.glPushMatrix();
    ...
    {
        this.renderNew((EntityAnkylosaurus)var1, var2, var4, var6, var8, var9);
    }
