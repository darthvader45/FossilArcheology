...
{
    public RenderPachycephalosaurus(ModelBase var1, float var2)
    {
        super(var1, var2);
        this.setRenderPassModel(var1);
    }

    public RenderPachycephalosaurus(ModelBase var1, ModelBase var2, float var3)
    {
        super(var1, var3);
    ...
    public void renderCow(EntityPachycephalosaurus var1, double var2, double var4, double var6, float var8, float var9)
    {
        ...
        try
        {
            ...
            if (!var1.Running)
            {
                ((ModelPachycephalosaurus)this.mainModel).render(var1, var16, var15, var13, var11 - var10, var12, var14);
            }
            else
            {
                ((ModelPachycephalosaurus)this.mainModel).render(var1, var16, var15, var13, var11 - var10, var12, var14);
            ...
            for (int var17 = 0; var17 < 4; ++var17)
            {
                ...
                {
                    ((ModelPachycephalosaurus)this.renderPassModel).render(var1, var16, var15, var13, var11 - var10, var12, var14);
