...
public class EntitySaberCat extends EntityTameable
{
    ...
    {
        super(var1);
        this.texture = "/mods/fossil/textures/mob/SaberCat_Adult.png";
    ...
    {
    	p0.reset();
    	p0.PrintStringXY(Localizations.getLocalizedString(LocalizationStrings.ANIMAL_SABERCAT), 97, 23,40,90,245);
    	if(this.isTamed())
    	{
