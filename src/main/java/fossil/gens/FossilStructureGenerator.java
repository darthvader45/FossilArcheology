			...
			BiomeGenBase biome = world.getWorldChunkManager().getBiomeGenAt(x, z);
		    			...
		    			|| biome instanceof BiomeGenSwamp)
		    	{
					...
					case 1: // ancient stone
			    		world.setBlock(x, y, z, Block.cobblestoneMossy.blockID); break;
					case 2: //stone brick
						world.setBlock(x, y, z, Fossil.ancientWood.blockID); break;
						default:
							world.setBlock(x, y, z, Block.obsidian.blockID); break;
					}
		    			...
		    			|| biome instanceof BiomeGenSnow)
		    	{
					...
					{
					case 1: // ancient stone
						world.setBlock(x, y, z, Fossil.ancientStonebrick.blockID); break;
					case 2: //stone brick
						world.setBlock(x, y, z, Block.stoneBrick.blockID); break;
					default:
						world.setBlock(x, y, z, Block.obsidian.blockID); break;
					}
		    			...
		    			|| biome instanceof BiomeGenDesert)
		    	{
					...
					{
					case 1: // ancient stone
						world.setBlock(x, y, z, Block.sandStone.blockID, 2, 2); break;
					case 2: //stone brick
						world.setBlock(x, y, z, Block.sandStone.blockID); break;
					default:
						world.setBlock(x, y, z, Block.obsidian.blockID); break;
					}
