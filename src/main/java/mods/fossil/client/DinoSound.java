...
public class DinoSound
{
    ...
    public static String[] files =
    {
        ...
        SOUND_RESOURCE_LOCATION + "mosasaurus/mosasaurus_attack1.wav",
        SOUND_RESOURCE_LOCATION + "mosasaurus/mosasaurus_death1.wav",
        SOUND_RESOURCE_LOCATION + "mosasaurus/mosasaurus_death2.wav",
        SOUND_RESOURCE_LOCATION + "mosasaurus/mosasaurus_hurt.wav",
        SOUND_RESOURCE_LOCATION + "mosasaurus/mosasaurus_living1.wav",
        SOUND_RESOURCE_LOCATION + "mosasaurus/mosasaurus_living2.wav",
        SOUND_RESOURCE_LOCATION + "mosasaurus/mosasaurus_outside1.wav",
        SOUND_RESOURCE_LOCATION + "mosasaurus/mosasaurus_outside2.wav",
        SOUND_RESOURCE_LOCATION + "mosasaurus/mosasaurus_outside3.wav",
        SOUND_RESOURCE_LOCATION + "mosasaurus/mosasaurus_outside4.wav",
    ...
    //plesiosaurus
    public static final String plesiosaurus_death = SOUND_PREFIX + "plesiosaurus_death";
    public static final String plesiosaurus_living = SOUND_PREFIX + "plesiosaurus_living";
    public static final String plesiosaurus_hurt = SOUND_PREFIX + "plesiosaurus_hurt";

    //pterosaurus
    public static final String pterosaurus_death = SOUND_PREFIX + "pterosaurus_death";
    public static final String pterosaurus_living = SOUND_PREFIX + "pterosaurus_living";
    public static final String pterosaurus_hurt = SOUND_PREFIX + "pterosaurus_hurt";
