...
public class BlockVolcanicSlab extends BlockHalfSlab
{
    public static final String[] blockStepTypes = { "volcanicBrick" };
    private Icon theIcon;

    public BlockVolcanicSlab(int par1, boolean par2)
    {
    ...
    {
        return new ItemStack(Fossil.volcanicSingleSlab.blockID, 2, par1 & 7);
    }
    ...
    {
        if (par1 != Fossil.volcanicDoubleSlab.blockID)
        {
