...
public class EntityWhipAttack extends EntityFishHook implements IEntityAdditionalSpawnData
{
...
public EntityWhipAttack(World par1World)
{
super(par1World);
this.xTile = -1;
this.yTile = -1;
...
@SideOnly(Side.CLIENT)
public EntityWhipAttack(World par1World, double par2, double par4, double par6, EntityPlayer par8EntityPlayer)
{
this(par1World);
...
public EntityWhipAttack(World par1World, EntityPlayer par2EntityPlayer)
{
super(par1World);
this.xTile = -1;
this.yTile = -1;
...
ItemStack fish = new ItemStack(Item.fishRaw, 1);
fish = new ItemStack(Item.fishRaw);
entityitem = new EntityItem(this.worldObj, this.posX, this.posY, this.posZ, fish);
...
{
        // this.angler = this.worldObj.(data.readInt());
}
}